...
const dataTableOptions = {
    columnDefs:[
        {className:"centered",target:[1,2,3]}
    ],
...
const iniDataTable=async()=>{
    ...
    await listUsers();
    dataTable = $("#dataTable_recomendacion").DataTable(dataTableOptions);
...
const listUsers=async()=>{
    try {
        ...
        tituloPlaylist.innerHTML=tituloplay;
        tableBody_recomendacion.innerHTML=content;
